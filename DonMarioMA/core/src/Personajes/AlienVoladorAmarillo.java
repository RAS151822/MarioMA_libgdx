 ...
 * @author Wunderton
 */
public class AlienVoladorAmarillo extends Image{
    ...
    public AlienVoladorAmarillo() {
        final float width = 124;
        final float height = 108;
        this.setSize(1, height / width);

        Texture koalaTexture = new Texture("AlienYellow.png");
